...
        {
            var visitaPyPEncontrado = _appContext.VisitaPyPs.FirstOrDefault(d => d.Id == idVisitaPyP);
...
        {
            var visitaPyPEncontrado = _appContext.VisitaPyPs.FirstOrDefault(d => d.Id == visitaPyP.Id);
            if (visitaPyPEncontrado != null)
            {
